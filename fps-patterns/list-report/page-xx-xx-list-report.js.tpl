...
import './list-report/subpage-{{.Var.LowerPrefix}}-list-report.js';
    ...
    return html`
      <furo-vertical-flex>
        <ui5-shellbar
          ...
          <ui5-button icon="nav-back" slot="startButton" at-click="--homeRequested"></ui5-button>
        </ui5-shellbar>
        <subpage-{{.Var.LowerPrefix}}-list-report
          flex
          fn-focus="--pageActivated"
          fn-update-query-param="--pageQueryChanged(*.query)"
          at-record-selected="--recordSelected"
          at-escape-filter-panel="--escapeFilter"
        ></subpage-{{.Var.LowerPrefix}}-list-report>
      ...
      <furo-app-flow
        event="history-back"
        fn-emit="--homeRequested, --escapeFilter"
      ></furo-app-flow>
