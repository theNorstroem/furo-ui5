---
title: furo-ui5-data-select-labeled
...
<br>`import '@furo/components/src/furo-ui5-data-select-labeled.js';`<small>
<br>exports *FuroUi5DataSelectLabeled* js
<br>exports `<furo-ui5-data-select-labeled>` custom-element-definition
<br>superclass *LitElement*
<br> mixes *FBP*</small>

{{% api "_furo-ui5-data-select-labeled-head.md" %}}
...
{{% api "_furo-ui5-data-select-labeled-description.md" %}}


## Attributes and Properties
{{% api "_furo-ui5-data-select-labeled-properties.md" %}}
...
<br><br>
## Events
{{% api "_furo-ui5-data-select-labeled-events.md" %}}
...
## Methods
{{% api "_furo-ui5-data-select-labeled-methods.md" %}}
...
## Slots
{{% api "_furo-ui5-data-select-labeled-slots.md" %}}
...
{{% api "_furo-ui5-data-select-labeled-footer.md" %}}
{{% api "_furo-ui5-data-select-labeled-scripts.md" %}}
