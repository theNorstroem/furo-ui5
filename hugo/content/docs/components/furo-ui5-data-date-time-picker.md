---
title: furo-ui5-data-date-time-picker
...
<br>`import '@furo/components/src/furo-ui5-data-date-time-picker.js';`<small>
<br>exports *FuroUi5DataDateTimePicker* js
<br>exports `<furo-ui5-data-date-time-picker>` custom-element-definition
<br>extends *src/furo-ui5-data-date-time-picker.js*
<br> mixes *FieldNodeAdapter*</small>

{{% api "_furo-ui5-data-date-time-picker-head.md" %}}
...
{{% api "_furo-ui5-data-date-time-picker-description.md" %}}


## Attributes and Properties
{{% api "_furo-ui5-data-date-time-picker-properties.md" %}}
...
<br><br>
## Events
{{% api "_furo-ui5-data-date-time-picker-events.md" %}}
...
## Methods
{{% api "_furo-ui5-data-date-time-picker-methods.md" %}}
...
{{% api "_furo-ui5-data-date-time-picker-footer.md" %}}
{{% api "_furo-ui5-data-date-time-picker-scripts.md" %}}
