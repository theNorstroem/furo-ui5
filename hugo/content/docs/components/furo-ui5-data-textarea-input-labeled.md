---
title: furo-ui5-data-textarea-input-labeled
...
<br>`import '@furo/components/src/furo-ui5-data-textarea-input-labeled.js';`<small>
<br>exports *FuroUi5DataTextareaInputLabeled* js
<br>exports `<furo-ui5-data-textarea-input-labeled>` custom-element-definition
<br>superclass *LitElement*
<br> mixes *FBP*</small>

{{% api "_furo-ui5-data-textarea-input-labeled-head.md" %}}
...
{{% api "_furo-ui5-data-textarea-input-labeled-description.md" %}}


## Attributes and Properties
{{% api "_furo-ui5-data-textarea-input-labeled-properties.md" %}}
...
## Methods
{{% api "_furo-ui5-data-textarea-input-labeled-methods.md" %}}
...
{{% api "_furo-ui5-data-textarea-input-labeled-footer.md" %}}
{{% api "_furo-ui5-data-textarea-input-labeled-scripts.md" %}}
