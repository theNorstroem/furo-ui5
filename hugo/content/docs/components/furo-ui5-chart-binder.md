...
<br>`import '@furo/components/src/furo-ui5-chart-binder.js';`<small>
<br>exports `<furo-ui5-chart-binder>` custom-element-definition
<br>superclass *LitElement*</small>

{{% api "_furo-ui5-chart-binder-head.md" %}}
...
{{% api "_furo-ui5-chart-binder-description.md" %}}


## Attributes and Properties
{{% api "_furo-ui5-chart-binder-properties.md" %}}
...
<br><br>
## Events
{{% api "_furo-ui5-chart-binder-events.md" %}}
...
## Methods
{{% api "_furo-ui5-chart-binder-methods.md" %}}
...
{{% api "_furo-ui5-chart-binder-footer.md" %}}
{{% api "_furo-ui5-chart-binder-scripts.md" %}}
