---
title: display-furo-integerproperty
description: 
weight: 50
---
...
<br>`import '@furo/typerenderer/src/display-furo-integerproperty.js';`<small>
...
## Methods
{{% api "_display-furo-integerproperty-methods.md" %}}
...
{{% api "_display-furo-integerproperty-footer.md" %}}
{{% api "_display-furo-integerproperty-scripts.md" %}}
