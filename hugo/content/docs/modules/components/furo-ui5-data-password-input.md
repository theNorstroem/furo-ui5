---
title: furo-ui5-data-password-input
...
<br>`import '@furo/components/src/furo-ui5-data-password-input.js';`<small>
<br>exports *FuroUi5PasswordInput* js
<br>exports `<furo-ui5-data-password-input>` custom-element-definition
<br>extends *src/furo-ui5-data-password-input.js*
<br> mixes *FieldNodeAdapter*</small>

{{% api "_furo-ui5-data-password-input-head.md" %}}
...
{{% api "_furo-ui5-data-password-input-description.md" %}}


## Attributes and Properties
{{% api "_furo-ui5-data-password-input-properties.md" %}}
...
<br><br>
## Events
{{% api "_furo-ui5-data-password-input-events.md" %}}
...
## Methods
{{% api "_furo-ui5-data-password-input-methods.md" %}}
...
{{% api "_furo-ui5-data-password-input-footer.md" %}}
{{% api "_furo-ui5-data-password-input-scripts.md" %}}
