 ...
 * @customElement
 * @demo demo-furo-ui5-collection-dropdown-labeled Simple use
 * @appliesMixin FBP
 */
export class FuroUi5CollectionDropdownLabeled extends FBP(LitElement) {
  constructor() {
    super();
    this.label = '';
...
window.customElements.define(
  'furo-ui5-collection-dropdown-labeled',
  FuroUi5CollectionDropdownLabeled
);
