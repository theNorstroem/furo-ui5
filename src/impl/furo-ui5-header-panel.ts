...
import type { FuroUi5ShowHide } from "@/impl/FuroUi5ShowHide";
      ...
      const ro = new ResizeObserver(entries => {
        window.requestAnimationFrame(() => {
          ...
          if (width > 0 && width < 406) {
            ...
            wrappersize = (this.shadowRoot!.querySelector(".wrapper") as HTMLElement).offsetWidth;
