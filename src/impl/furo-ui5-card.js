 ...
 *```
 *
 * @slot {HTMLElement[]} action - defines an action, displayed in the right most part of the header. Note: If status is set, the status text will be displayed, you can either have action, or status.
 * @slot {HTMLElement[]} content - defines the content of the card
 *
