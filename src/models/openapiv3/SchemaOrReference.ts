...
export class SchemaOrReference extends FieldNode {
  /**
   **/
  private _schema: RECURSION<OpenapiV3Schema, IOpenapiV3Schema>;
  ...
  constructor(initData?: ISchemaOrReference, parent?: FieldNode, parentAttributeName?: string) {
    ...
    this.__meta.description = "SchemaOrReference";
    ...
    /**
     **/
    this._schema = new RECURSION<OpenapiV3Schema, IOpenapiV3Schema>(undefined, this, "schema");
   ...
   **/
  public get schema(): RECURSION<OpenapiV3Schema, IOpenapiV3Schema> {
    return this._schema;
  }

  /**
   * The setter receives `IOpenapiV3Schema | null`
   **/
  public set schema(v: IOpenapiV3Schema | null) {
  ...
  fromLiteral(data: ISchemaOrReference): void {
    super.__fromLiteral(data);
  }

  toLiteral(): ISchemaOrReference {
    return super.__toLiteral() as ISchemaOrReference;
  }
}
