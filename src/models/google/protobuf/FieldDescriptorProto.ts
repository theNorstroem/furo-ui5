...
export class FieldDescriptorProto extends FieldNode {
  ...
  constructor(initData?: IFieldDescriptorProto, parent?: FieldNode, parentAttributeName?: string) {
    ...
    this.__meta.description = "FieldDescriptorProto Describes a field within a message.";
  ...
  /**
   * The setter receives `GoogleProtobufFieldDescriptorProtoLabel`
   **/
  ...
  /**
   * The setter receives `GoogleProtobufFieldDescriptorProtoType`
   **/
  ...
  toLiteral(): IFieldDescriptorProto {
    return super.__toLiteral() as IFieldDescriptorProto;
  }
}
