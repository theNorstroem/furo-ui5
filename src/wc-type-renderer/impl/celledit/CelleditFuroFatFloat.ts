 ...
 */
export class CelleditFuroFatFloat extends CelleditInt32 {
  /**
   * @private
   */
  static get metadata() {
...
declare global {
  interface HTMLElementTagNameMap {
    "CelleditFuroFatFloat": CelleditFuroFatFloat;
  }
}

import CelleditFuroFatFloat from "@/wc-type-renderer/impl/CelleditFuroFatFloat
