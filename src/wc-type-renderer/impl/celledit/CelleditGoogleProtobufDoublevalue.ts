 ...
 */
export class CelleditGoogleProtobufDoublevalue extends CelleditInt32 {
  /**
   * @private
   */
  static get metadata() {
...
import CelleditGoogleProtobufDoublevalue from "@/wc-type-renderer/impl/CelleditGoogleProtobufDoublevalue
