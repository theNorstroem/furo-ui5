 ...
 * @customElement
 * @demo demo-furo-ui5-collection-dropdown Basic Usage
 * @demo demo-furo-ui5-collection-dropdown-auto Autoselect first
 */
export class FuroUi5CollectionDropdown extends Select.default {
  constructor() {
    super();

    // eslint-disable-next-line no-console
    console.warn(
      'furo-ui5-collection-dropdown is deprecated since 2021-06-18. ' +
        'Please switch to furo-ui5-select before 2021-Q4.'
    );
