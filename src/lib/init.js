...
registerLocaleDataLoader('de_CH', () =>
  ...
  import('../../assets/cldr/de_CH.js').then(cldr => cldr.default())
);

registerLocaleDataLoader('de_AT', () =>
  // eslint-disable-next-line import/no-extraneous-dependencies
  import('../../assets/cldr/de_AT.js').then(cldr => cldr.default())
);

registerLocaleDataLoader('de', () =>
  // eslint-disable-next-line import/no-extraneous-dependencies
  import('../../assets/cldr/de.js').then(cldr => cldr.default())
);

registerLocaleDataLoader('it', () =>
  // eslint-disable-next-line import/no-extraneous-dependencies
  import('../../assets/cldr/it.js').then(cldr => cldr.default())
);
