...
declare module "react" {
  namespace JSX {
    interface IntrinsicElements {
       ...
       * - [Shift] - If [Space] / [Enter] or [Return] is pressed, pressing [Shift] releases the furo-furo-ui5-icon without triggering the click event.
       *
       * ### ES6 Module Import
       *
       ...
       *
       * - [Space] / [Enter] or [Return] - Fires the `click` event if the `mode` property is set to `Interactive`.
       * - [Shift] - If [Space] / [Enter] or [Return] is pressed, pressing [Shift] releases the furo-ui5-icon without triggering the click event.
       *
       * ### ES6 Module Import
       *
       * `import "@furo/ui5/dist/Icon.js";`
