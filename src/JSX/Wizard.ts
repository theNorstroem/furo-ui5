...
export interface Wizard extends React.HTMLAttributes<HTMLElement> {
  "onstep-change"?: (d: CustomEvent<WizardStepChangeEventDetail>) => void;
  // properties
...
declare module "react" {
  namespace JSX {
    interface IntrinsicElements {
       ...
       *
       * ```html
       * <furo-ui5-dialog style="height: 80%">
       * <furo-ui5-wizard></furo-ui5-wizard>
       * </furo-ui5-dialog>
       * ```
       *
       * #### Moving to next step
       ...
       *
       * ### ES6 Module Import
       * `import "@furo/ui5/dist/Wizard.js";` (includes <furo-ui5-wizard-step/>)
       *
       * ### Overview
       *
       * The `furo-ui5-wizard` helps users to complete a complex task by dividing it into sections and guiding them through it.
