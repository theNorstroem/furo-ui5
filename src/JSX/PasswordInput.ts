...
export interface PasswordInput extends React.HTMLAttributes<HTMLElement> {
  onchange?: (d: CustomEvent) => void;
  onclose?: (d: CustomEvent) => void;
  oninput?: (d: CustomEvent) => void;
  onopen?: (d: CustomEvent) => void;
  "onpassword-hidden"?: (d: void) => void;
  "onpassword-showed"?: (d: void) => void;
...
declare module "react" {
  namespace JSX {
    interface IntrinsicElements {
       ...
       */
      "furo-ui5-password-input": PasswordInput;
    }
  }
}
