 ...
 * @appliesMixin FBP
 */
export class FuroUi5RadioButtonGroup extends FieldNodeAdapter(HTMLElement) {
  constructor() {
    super();
  ...
  _updateFNA(e) {
    ...
    if (
      ...
      selectedOption = this._optionList.repeats.find(
        obj =>
          FuroUi5RadioButtonGroup.getValueByPath(
            obj,
      ...
      if (selectedOption) {
        newValue = FuroUi5RadioButtonGroup.getValueByPath(
          selectedOption,
  ...
  _updateOptions(list) {
    ...
    if (this._optionList && this._optionList.repeats) {
      this._optionList.repeats.forEach(item => {
        ...
        optionItem.text = FuroUi5RadioButtonGroup.getValueByPath(
          item,
