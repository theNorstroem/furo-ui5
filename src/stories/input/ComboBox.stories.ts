...
const component = "furo-ui5-combobox";
  ...
  parameters: {
    ...
    docs: {
      page: DocumentationTemplate({
        component,
        since: "2.0.0",
        originalComponent: "https://ui5.github.io/webcomponents/components/ComboBox/",
        guideline: "https://www.sap.com/design-system/fiori-design-web/v1-139/ui-elements/combo-box-web-component/",
      }),
    },
    a11y: {
...
export const ManuallyAddedOptions: StoryObj = {
  args: {
    defaultSlot:
      '<furo-ui5-cb-item text="Manually added"></furo-ui5-cb-item>\n<furo-ui5-cb-item icon="product" text="Second added manually"></furo-ui5-cb-item>',
  },
