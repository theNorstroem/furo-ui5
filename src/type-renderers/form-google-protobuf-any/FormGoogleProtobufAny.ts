...
/**
 * `form-google-protobuf-any`
 * The form-google-protobuf-any component displays a FieldNode of type `google.protobuf.Any`
 * in form mode.
 *
 ...
 * renderer for the payload's real type in the `form` context. The label and the form row come
 * from that resolved renderer, exactly as they would if the field were not wrapped in an Any.
 *
 * Because of that an Any field needs **two** imports — this renderer, and whatever the payload
 * turns out to be:
 *
 * ```js
 * import "@furo/ui5/type-renderers/form-google-protobuf-any";
 * import "@furo/ui5/type-renderers/form-furo-type-date"; // whatever arrives inside
 * ```
 *
 ...
 *
 * @summary form renderer for `google.protobuf.Any`
 * @element form-google-protobuf-any
 */
export class FormGoogleProtobufAny extends LitElement {
  @state()
  ...
  override render() {
    ...
    // language=HTML
    return html` <furo-ui5-typerenderer context="form" .model="${this.payload}"></furo-ui5-typerenderer> `;
  }
}
