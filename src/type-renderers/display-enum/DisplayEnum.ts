...
/**
 * `display-enum`
 * The display-enum component displays a FieldNode of type `enum` in read only mode.
 *
 ...
 *
 * @summary display renderer for `enum`
 * @element display-enum
 */
export class DisplayEnum extends LitElement {
  @state()
