 ...
 * The form-google-protobuf-doublevalue component displays a FieldNode of type `google.protobuf.DoubleValue` in form mode.
 *
 * @author veith
 * @tagname form-google-protobuf-doublevalue
 * @public
 */
export class FormGoogleProtobufDoublevalue extends LitElement {
