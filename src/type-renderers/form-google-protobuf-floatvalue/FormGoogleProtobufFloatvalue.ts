 ...
 * The form-google-protobuf-floatvalue component displays a FieldNode of type `google.protobuf.FloatValue` in form mode.
 *
 * @author veith
 * @tagname form-google-protobuf-floatvalue
 * @public
 */
export class FormGoogleProtobufFloatvalue extends LitElement {
