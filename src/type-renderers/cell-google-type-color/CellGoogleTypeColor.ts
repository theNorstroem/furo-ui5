 ...
 */
export class CellGoogleTypeColor extends LitElement {
  constructor() {
    super();
    this._red = "";
    this._green = "";
  ...
  _getTemplate() {
    return html`
      <ui5-color-palette> <ui5-color-palette-item value="rgb(${this._red},${this._green},${this._blue})"></ui5-color-palette-item></ui5-color-palette>
    `;
  }
