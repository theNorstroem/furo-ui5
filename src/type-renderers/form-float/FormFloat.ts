...
/**
 * `form-float`
 * The form-float component displays a FieldNode of type `float` in form mode.
 *
 * @author veith
 * @tagname form-float
 * @public
 */
export class FormFloat extends LitElement {
  private _model: FLOAT = new FLOAT();

  get model(): FLOAT {
    return this._model;
  }

  set model(value: FLOAT) {
    this.bindData(value);
  }
   ...
   * @public
   */
  bindData(fieldNode: FLOAT | undefined): void {
