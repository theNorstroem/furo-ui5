...
import { NumberProperty } from "@/models/furo/NumberProperty";

/**
 * `cell-furo-numberproperty`
 * The cell-furo-numberproperty component displays a FieldNode of type `furo.NumberProperty` in read only mode.
 *
 ...
 */
export class CellFuroNumberproperty extends LitElement {

  @state()
  private displayValue = "";

  private _model: NumberProperty = new NumberProperty();

  get model(): NumberProperty {
    return this._model;
  }

  set model(value: NumberProperty) {
    this.bindData(value);
  }
   ...
   * @public
   */
  bindData(fieldNode: NumberProperty | undefined): void {
