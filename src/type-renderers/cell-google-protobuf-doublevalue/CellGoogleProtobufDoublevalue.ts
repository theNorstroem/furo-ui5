...
import { DoubleValue } from "@furo/open-models";
import { LitElement, html, css } from "lit";
import { state } from "lit/decorators.js";

/**
 * `cell-google-protobuf-doublevalue`
 * The cell-google-protobuf-doublevalue component displays a FieldNode of type
 ...
 */
export class CellGoogleProtobufDoublevalue extends LitElement {
  @state()
  private displayValue = "";

  private _model: DoubleValue = new DoubleValue();

  get model(): DoubleValue {
    return this._model;
  }

  set model(value: DoubleValue) {
    this.bindData(value);
  }
   ...
   * @public
   */
  bindData(fieldNode: DoubleValue | undefined): void {
