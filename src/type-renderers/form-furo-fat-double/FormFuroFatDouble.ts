...
import { FuroFatDouble } from "@/models";
 ...
 * The form-furo-fat-double component displays a FieldNode of type `furo.fat.Double` in form mode.
 *
 * @author veith
 * @tagname form-furo-fat-double
 * @public
 */
export class FormFuroFatDouble extends LitElement {
  private _model: FuroFatDouble = new FuroFatDouble();

  get model(): FuroFatDouble {
    return this._model;
  }

  set model(value: FuroFatDouble) {
    this.bindData(value);
  }
   ...
   * @public
   */
  bindData(fieldNode: FuroFatDouble | undefined): void {
