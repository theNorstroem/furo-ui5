 ...
 * The celledit-google-protobuf-any component edits a FieldNode of type `google.protobuf.Any`
 * in a table cell.
 *
 ...
 * renderer for the payload's real type in the `celledit` context.
 *
 * Because of that an Any field needs **two** imports — this renderer, and whatever the payload
 * turns out to be:
 *
 * ```js
 * import "@furo/ui5/type-renderers/celledit-google-protobuf-any";
 * import "@furo/ui5/type-renderers/celledit-furo-type-date"; // whatever arrives inside
 * ```
 *
...
export class CelleditGoogleProtobufAny extends LitElement {
  ...
  override render() {
    ...
    // language=HTML
    return html` <furo-ui5-typerenderer context="celledit" .model="${this.payload}"></furo-ui5-typerenderer> `;
  }
}
