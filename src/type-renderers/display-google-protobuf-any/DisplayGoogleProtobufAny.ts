 ...
 * The display-google-protobuf-any component displays a FieldNode of type `google.protobuf.Any`
 * in read only mode.
 *
 ...
 * renderer for the payload's real type in the `display` context.
 *
 ...
 *
 * @summary display renderer for `google.protobuf.Any`
 * @element display-google-protobuf-any
 */
export class DisplayGoogleProtobufAny extends LitElement {
  ...
  override render() {
    ...
    // language=HTML
    return html` <furo-ui5-typerenderer context="display" .model="${this.payload}"></furo-ui5-typerenderer> `;
  }
}
