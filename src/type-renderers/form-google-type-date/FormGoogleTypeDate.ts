 ...
 * The form-google-type-date component displays a FieldNode of type `google.type.Date` in form mode.
 *
 * @author veith
 * @tagname form-google-type-date
 * @public
 */
export class FormGoogleTypeDate extends LitElement {
  ...
  override render() {
    return html`<furo-ui5-form-row>
      ...
      <furo-ui5-date-picker .model="${this.model}" id="input-field" ?disabled="${this.disabled}" accessible-name="${this.label ?? this.LABEL}"></furo-ui5-date-picker>
    </furo-ui5-form-row>`;
  }
}
