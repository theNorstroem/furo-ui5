...
import { FuroUi5CheckboxInput } from "@/impl/FuroUi5CheckboxInput";
...
export class CelleditBool extends FuroUi5CheckboxInput {
  ...
  static get styles() {
    return [
      super.styles,
      {
        content: ".ui5-checkbox-root:focus:before{top:-1px;height:100%;display:var(--_ui5_checkbox_focus_outline_display)",
      },
    ];
  }
}
