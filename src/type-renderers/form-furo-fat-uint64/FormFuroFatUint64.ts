...
import { FuroFatUint64 } from "@/models";
 ...
 * The form-furo-fat-uint64 component displays a FieldNode of type `furo.fat.Uint64` in form mode.
 *
 * @author veith
 * @tagname form-furo-fat-uint64
 * @public
 */
export class FormFuroFatUint64 extends LitElement {
  private _model: FuroFatUint64 = new FuroFatUint64();

  get model(): FuroFatUint64 {
    return this._model;
  }

  set model(value: FuroFatUint64) {
    this.bindData(value);
  }
   ...
   * @public
   */
  bindData(fieldNode: FuroFatUint64 | undefined): void {
