...
const component = "furo-ui5-popover";
const componentInfo = {
  guideline: "https://www.sap.com/design-system/fiori-design-web/v1-142/ui-elements/popover/",
  originalComponent: "https://ui5.github.io/webcomponents/components/Popover/",
};
...
const openPopover = (e: Event): void => {
  const popover = document.getElementById("story-popover") as (HTMLElement & { showAt: (o: HTMLElement) => void }) | null;
...
export const Default: StoryObj = {
  ...
  render: renderArgs => html`
    <furo-ui5-button design="Emphasized" @click="${openPopover}">Open popover</furo-ui5-button>
    ...
    >
      ...
      <div style="padding: 0.5rem; max-width: 18rem;">
        <furo-ui5-label>This is a non-modal popover anchored to the button that opened it.</furo-ui5-label>
      </div>
    </furo-ui5-popover>
  `,
};
