 ...
 *
 * @summary Color swatches in a popover with selected-color data binding.
 * @keywords color, palette, popover, swatch, picker, value
 * @category Form
 * @usecase Use to let users pick a color from a predefined set shown in a popover.
 * @related furo-ui5-color-palette, furo-ui5-color-palette-item, furo-ui5-color-picker
 * @tagname furo-ui5-color-palette-popover
 */
export class FuroUi5ColorPalettePopover extends ColorPalettePopover {
  /**
  ...
  private stringReaderWriters: StringReaderWriters<FuroUi5ColorPalettePopover> | undefined;
  ...
  public bindData(fieldNode: STRING | FuroFatString | StringValue | undefined) {
    ...
    this.stringReaderWriters = new StringReaderWriters<FuroUi5ColorPalettePopover>(this, "value", this._model);
  ...
  static override get metadata() {
    return { ...super.metadata, tag: "furo-ui5-color-palette-popover" };
  }
}
