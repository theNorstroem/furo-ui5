...
const component = "furo-ui5-side-navigation";
  ...
  parameters: {
    ...
    docs: {
      page: DocumentationTemplate({
        component,
        since: "0.9.0",
        originalComponent: "https://ui5.github.io/webcomponents/components/fiori/SideNavigation/",
      }),
    },
  },
};
...
export const Default: StoryObj = {
  render: renderArgs => html`
    <furo-ui5-side-navigation accessible-name="${ifDefined(renderArgs.accessibleName)}" ?collapsed="${renderArgs.collapsed}" style="height:260px">
