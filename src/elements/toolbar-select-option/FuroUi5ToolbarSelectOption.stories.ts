...
const component = "furo-ui5-toolbar-select-option";
const { events, args, argTypes } = getStorybookHelpers(component);
ArgsTransormAll(argTypes, args, []);

const meta: Meta = {
  title: "layout/Toolbar/ToolbarSelectOption",
  component,
  subcomponents: {},
  tags: ["autodocs"],
  argTypes,
  ...
  parameters: {
    ...
    docs: {
      page: DocumentationTemplate({
        component,
        since: "0.9.0",
        originalComponent: "https://ui5.github.io/webcomponents/components/ToolbarSelectOption/",
      }),
    },
  },
};
