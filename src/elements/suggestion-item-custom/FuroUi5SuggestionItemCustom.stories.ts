...
export const Default: StoryObj = {
  ...
  render: renderArgs => html`
    <furo-ui5-text-input show-suggestions placeholder="Type 'Z'">
      <furo-ui5-suggestion-item-custom text="${ifDefined(renderArgs.text)}">
        <div style="display:flex;gap:.5rem;align-items:center"><furo-ui5-icon name="building"></furo-ui5-icon><span>Zurich, CH</span></div>
