name: UnsubscribeProjectMember
type: UnsubscribeProjectMember
...
fields:
    body:
        ...
        meta:
            default: ""
            placeholder: projectmemberservice.unsubscribeprojectmember.body.placeholder
            hint: ""
            label: projectmemberservice.unsubscribeprojectmember.body.label
            options:
                flags: []
                list: []
            readonly: false
