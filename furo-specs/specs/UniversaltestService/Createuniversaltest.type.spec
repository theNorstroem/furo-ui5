name: Createuniversaltest
type: Createuniversaltest
...
fields:
    body:
        ...
        meta:
            default: ""
            placeholder: universaltestservice.createuniversaltest.body.placeholder
            hint: ""
            label: universaltestservice.createuniversaltest.body.label
            options:
                flags: []
                list: []
            readonly: false
