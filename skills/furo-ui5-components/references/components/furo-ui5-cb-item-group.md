---
title: furo-ui5-cb-item-group
tags: [combobox, group, header, suggestion, category, item]
category: Form
use-when: Use inside furo-ui5-combobox to group suggestions into labelled sections.
---

# furo-ui5-cb-item-group

> Groups combobox suggestions under a header.
...
**Related:** [`furo-ui5-combobox`](furo-ui5-combobox.md), [`furo-ui5-cb-item`](furo-ui5-cb-item.md), [`furo-ui5-cb-item-custom`](furo-ui5-cb-item-custom.md)
...
This is a pass-through wrapper around `furo-ui5-cb-item-group`: the UI5 API (properties, events,
...
Defines the items of the `ui5-cb-item-group`.
