...
tags: [number, numeric, input, integer, float, decimal, form]
category: Form
use-when: Use for entering numeric values such as quantities or measurements.
---

# furo-ui5-number-input

> Numeric input field for entering numbers bound to numeric types.
...
**Related:** [`furo-ui5-text-input`](furo-ui5-text-input.md), [`furo-ui5-step-input`](furo-ui5-step-input.md), [`furo-ui5-slider`](furo-ui5-slider.md)
...
| `model` | `\| INT32     \| INT64     \| UINT32     \| UINT64     \| DOUBLE     \| FLOAT     \| FuroFatDouble     \| FuroFatFloat     \| FuroFatInt32     \| FuroFatInt64     \| FuroFatUint32     \| FuroFatUint64     \| DoubleValue     \| FloatValue     \| Int32Value     \| Int64Value     \| UInt32Value     \| UInt64Value` | Use this to bind a model field by attribute. |
