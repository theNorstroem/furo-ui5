---
title: furo-ui5-form-layout
tags: [form, layout, responsive, groups, columns, structure]
category: FormLayout
use-when: Use as the main container for forms with one or more form groups.
---

# furo-ui5-form-layout

> Responsive form container organizing form groups with adaptive column layout.
...
Slot for action items, prefer transparent design on buttons.
