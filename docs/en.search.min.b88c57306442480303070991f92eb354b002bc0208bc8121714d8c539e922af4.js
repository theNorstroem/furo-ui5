...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4db8525de5c057f3a5a9d19f250917828caa958fbecf8b186ed116496111400d.js',function(){input.required=false;search();});}
