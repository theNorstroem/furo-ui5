...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.390c0e630535d4fe5e7f111b46028ba8f2637d275bd71a401791ba2a97acb1ca.js',function(){input.required=false;search();});}
