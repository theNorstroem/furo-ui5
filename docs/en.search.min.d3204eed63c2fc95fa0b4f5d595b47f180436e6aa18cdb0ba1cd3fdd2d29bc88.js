...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4d4306d50fd029b3a44fdb4a0932c35c90272713a432a3c1399144e07590c2df.js',function(){input.required=false;search();});}
