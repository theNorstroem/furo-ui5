...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d2604be557cd320646470a57c80a8fa5a4d536e8d9516b805ce48bd2e0c3ef3d.js',function(){input.required=false;search();});}
