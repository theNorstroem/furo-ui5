...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cbe94ba14c273a5f018c171120fae3a8a8195c16c12bc9cec5a66dd5e1d724d4.js',function(){input.required=false;search();});}
