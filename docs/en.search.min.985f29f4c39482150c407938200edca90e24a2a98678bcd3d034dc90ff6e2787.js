...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4bf0f8dd7bffb54e91d3c578058fb608f18a8652bd1683b86a1bbfeb5d3b8189.js',function(){input.required=false;search();});}
