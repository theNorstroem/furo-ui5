...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0d4a4a7d906cccb391cb9a66f9f85ff2d31bf17b0b45edadf1907db73ed85560.js',function(){input.required=false;search();});}
