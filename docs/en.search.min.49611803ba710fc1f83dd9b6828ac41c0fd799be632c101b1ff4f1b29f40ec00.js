...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fcbc02bf8218575533907a25fa7240e3666c67abc2e940752c68517a39111426.js',function(){input.required=false;search();});}
