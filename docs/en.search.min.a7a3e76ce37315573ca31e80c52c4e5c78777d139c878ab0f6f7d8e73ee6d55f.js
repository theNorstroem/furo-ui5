...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.70a8eef41b30c7eaeea7dffed6e67f6c2ff792e996974a0e757778c9b347dde4.js',function(){input.required=false;search();});}
