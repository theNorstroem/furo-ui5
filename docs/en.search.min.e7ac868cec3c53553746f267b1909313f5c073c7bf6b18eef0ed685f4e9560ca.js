...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e8092ed7d70c57969ef1e3044b935cbd61d4e6a8b5586374e203b28884cef5d0.js',function(){input.required=false;search();});}
