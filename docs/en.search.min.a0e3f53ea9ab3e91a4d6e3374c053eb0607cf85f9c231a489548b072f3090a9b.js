...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fdfdf8b682007d02a853395c8737c45ece9d6c97fe3c6e1346cc460e7b2a15ea.js',function(){input.required=false;search();});}
